...
Welcome to the Gadgets Mobile App! This React Native application, built with Expo, Zustand, and Supabase, is a complete gadgets-selling platform. This README will guide you through setting up the mobile application, running it locally, and understanding its structure.
...
1. **Clone the Repository:**
   ...
   ```bash
   git clone https://github.com/amx100/gadgets-app-react-native.git
